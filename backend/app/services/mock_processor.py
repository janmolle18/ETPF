...
class MockDocumentProcessor(BaseDocumentProcessor):
    async def process(self, document_id: uuid.UUID, file_path: str) -> Dict[str, Any]:
        ...
        layout_blocks = [
            {"text": vendor["name"], "x": 10.0, "y": 5.0, "width": 80.0, "height": 5.0, "confidence": 0.99},
            {"text": f"Tel: {vendor['phone']}", "x": 10.0, "y": 11.0, "width": 40.0, "height": 3.0, "confidence": 0.95},
            {"text": f"Steuer-Nr: {vendor['tax_id']}", "x": 10.0, "y": 14.0, "width": 50.0, "height": 3.0, "confidence": 0.98},
            {"text": "RECHNUNG", "x": 10.0, "y": 22.0, "width": 80.0, "height": 6.0, "confidence": 0.99},
            {"text": "Datum: 15.07.2026", "x": 10.0, "y": 30.0, "width": 30.0, "height": 3.0, "confidence": 0.97},
            {"text": f"Beleg-ID: {document_id}", "x": 10.0, "y": 33.0, "width": 60.0, "height": 3.0, "confidence": 0.96}
        ]
